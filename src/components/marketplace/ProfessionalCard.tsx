...
const ProfessionalCard: React.FC<{ professional: Professional }> = ({ professional }) => {
  ...
  return (
    <Link href={`/profesionales/${professional.slug}`} className="block h-full group">
      <article className="h-full rounded-[28px] border border-slate-200/60 bg-white p-5 shadow-[0_8px_28px_rgba(15,23,42,0.06)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_16px_44px_rgba(15,23,42,0.10)] flex flex-col">
        {/* Header */}
