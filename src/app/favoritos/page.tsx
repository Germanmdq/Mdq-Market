  ...
  return (
    <div className="max-w-[1440px] mx-auto px-4 sm:px-6 py-16">
      <div className="flex items-center justify-between mb-12">
         ...
         <span className="text-sm font-semibold text-slate-400 uppercase tracking-widest">{favorites.length} Items guardados</span>
      </div>
      ...
      {favorites.length > 0 ? (
        ...
        <div className="text-center py-32 bg-white rounded-[3rem] border border-slate-200 shadow-sm">
           ...
           <Link href="/productos" className="inline-flex items-center gap-2 bg-slate-950 text-white font-semibold px-8 py-4 rounded-full hover:bg-slate-800 transition-all shadow-sm">
